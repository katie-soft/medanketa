                  ...
                  text={
                    isMenuOpen ? (
                      <svg width='15' height='16' viewBox='0 0 15 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
                        ...
                        <path d='M14 14.0571L7.5 7.55713L1 1.05713' stroke='#1C597B' strokeLinecap='round' strokeLinejoin='round' />
                      </svg>
                    ) : (
                      <svg width='17' height='14' viewBox='0 0 17 14' fill='none' xmlns='http://www.w3.org/2000/svg'>
                        <path d='M16 0.557129L1 0.557129' stroke='#1C597B' strokeLinecap='round' strokeLinejoin='round' />
              ...
              <div className='user-actions'>
                ...
                {Boolean(isMob) && (
                  <IconWrapperUI bgColor='#F0F4F6' classN='header-menu'>
                    <CustomSelect chevronWidth={24} chevronHeight={24} options={sidebarItems} icon={<MenuLogo />} path='header' />
                  </IconWrapperUI>
                )}
