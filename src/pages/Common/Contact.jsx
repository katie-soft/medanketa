          ...
          <div className='tabs-cart'>
            ...
            <CardUI>
              ...
              <div className='card-wrapper-content'>
                ...
                <InputUI id='reference' type='text' placeholder='+7 999 999 99 99' />
              </div>
            </CardUI>
          </div>
          ...
          <div className='tabs-cart'>
            ...
            <CardUI>
              <div className='card-wrapper-content'>
                ...
                <InputUI id='email' type='email' placeholder='1111tasde2@mail.ru' />
              </div>
              <div className='card-wrapper-content'>
                <label htmlFor='mailForApplication'>Почта для сбора заявок</label>
                <InputUI id='mailForApplication' type='email' placeholder='1111tasde2@mail.ru' />
              </div>
            </CardUI>
          </div>
