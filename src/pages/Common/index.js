  ...
  return (
    <div className='comman-container list-pages'>
      <div className='tabs-title'>
        <PageListHeader titleText='Общее' description='Создавайте ваши персональные анкеты, и распространяйте среди пользователей' />
      </div>
      <TabsContainer renderContent={renderContent} tabs={tabs} handleClick={handleClick} activeIndex={activeIndex} />
    </div>
  )
}
