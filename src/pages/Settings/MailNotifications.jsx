...
export const MailNotifications = () => {
  ...
  const headers = [{ title: 'Название' }, { title: 'Получатель' }, { title: 'Дата изменения' }, { title: 'Статус' }, { title: 'Действие' }]
        ...
        <>
          {isMob ? (
            ...
            <WrapperUI className='table-wrapper'>
              <TableUI data={settingData} headers={headers} setTabIndex={setTabIndex} index={tabIndex} hasOnClick={changeContent} />
            </WrapperUI>
          )}
        </>
      )}
