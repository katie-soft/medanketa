        ...
        <div className='seo-cards-content'>
          <CardUI>
            <div className='card-wrapper-content'>
              ...
              <MulitiLineTextarea id='htaccess' firstLine='<Rewrite>' secondLine='...' thirdLine='</Rewrite>' />
            </div>
          </CardUI>
          ...
          <CardUI>
            <div className='card-wrapper-content'>
              ...
              <MulitiLineTextarea firstLine='Dissallow' secondLine='...' thirdLine='/' id='robots' />
            </div>
          </CardUI>
          ...
          <CardUI>
            <div className='card-wrapper-content'>
              ...
              <MulitiLineTextarea firstLine='<script>' secondLine='...' thirdLine='</script>' id='codeForSearch' />
            </div>
          </CardUI>
        </div>
